...
See [Install Page](install) for more information. We will be having an **InstallFest on Wednesday, Oct 2 from 10am to 12pm**. for those students experiencing difficulties downloading and installing the requisite software. 

#### Readings and Resources {-}

There are no official textbooks for this class. Some of the materials are drawn from [R for Data Science](https://r4ds.had.co.nz/) by Garrett Grolemund and Hadley Wickham. I encourage you to refer back to this back, as well as the many other R materials available for free online.
