...
There are some very common alterations researchs make on their data: changing column names, assigning NA values, changing column type.
...
We'll go into plotting in greater detail soon, but let's tough on 2 common graphs. First, a scatterplot:
