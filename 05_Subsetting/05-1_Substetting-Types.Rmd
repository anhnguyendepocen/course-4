...
#### 3. __Character vectors__ to return elements with matching names. This only works if the vector is named. {-}
...
Logical subsetting the most useful type of subsetting, because you use it to subset based on __conditional__ or __comparative__ statements.
