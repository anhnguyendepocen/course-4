...
Subset the results from challenge \#3 (above) to select only the \texttt{country}, \texttt{year}, and \texttt{gdpPercap\_diff} columns. Use \texttt{tidyr} put it in wide format so that countries are rows and years are columns.
...
Data stored in the form we have outlined above is considered \emph{normalized}. In general, we should try to keep data normalized as far into the code pipeline as we can. Storing normalized data
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-277-1} \end{center}
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-278-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-279-1} 
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-281-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-282-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-282-2} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-284-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-284-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-284-3} \end{center}
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-286-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-288-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-288-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-288-3} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-288-4} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-291-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-291-2} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-292-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-292-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-292-3} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-292-4} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-292-5} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-293-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-293-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-293-3} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-293-4} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-293-5} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-293-6} 
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-312-1} \end{center}

Note that we have 5 lines, one for each region, because of the \textbf{color} option is the global \texttt{aes} function. But if we move it, we get different restuls:
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-314-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-315-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-316-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-317-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-317-2} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-319-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-319-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-319-3} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-344-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-344-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-344-3} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-344-4} \end{center}
...
\CommentTok{#> % Date and time: Wed, Oct 16, 2019 - 19:55:25}
...
\tightlist
\item
  \textbf{\protect\hyperlink{common-string-operations}{common string operations}}, like concatinating, subsetting, and replacing strings.
\item
...
\hypertarget{common-string-operations}{%
\section{Common String Operations}\label{common-string-operations}}

\hypertarget{concatinating-strings-with-paste}{%
\subsection{\texorpdfstring{Concatinating strings with \texttt{paste()}}{Concatinating strings with paste()}}\label{concatinating-strings-with-paste}}
...
Using the usual combine operator \texttt{c()} on two or more character strings will not create a single character string, but rather a \textbf{vector} of character strings.
...
Combining two or more character strings into one larger character string requires using the \texttt{paste()} function. This function takes character strings or vectors and collapses their values into a single character string, with each value separated by a character string selected by the user.
...
\hypertarget{replace-substrings-with-gsub}{%
\subsection{\texorpdfstring{Replace Substrings with \texttt{gsub()}}{Replace Substrings with gsub()}}\label{replace-substrings-with-gsub}}

The function \texttt{gsub()} replaces substrings in a larger string using a specified pattern.
...
\texttt{gsub()} is part of a suite of functions to search and substitute substrings using \textbf{regular expressions} (or ``regex'' for short). For more information on regular expressions, see:
...
Please don't say that your paper fills a gap. If you have the urge, just ignore it and move on.
...
\citet{georgetownsfs} \& \citet{GUGovt} \textbar{} Blogger \citet{lefarkins} \textbar{} New book, \#ExitFromHegemony coming from \citet{OUPAcademic} in 2020: \url{https://t.co/LDYyA5vkMx}
...
c(``3033693676'', ``2816944560'', ``996923362386546694'', ``21114659'')

c(``pstanpolitics'', ``tanishafazal'', ``ProfPaulPoast'', ``ForeignAffairs'')
...
\citet{UChicago} political scientist and \citet{UChicagoCIR} director. Research on international relations and political violence in South Asia. Notifications muted.
...
twitter.com/JoshRovner1/st\ldots{}

\url{https://t.co/7aOWod93RU}

\url{https://twitter.com/JoshRovner1/status/1181996849529536513}
...
c(``1151193788'', ``186755547'')

c(``JoshRovner1'', ``lawfareblog'')

en

1181996849529536513

Should intelligence officials publicly dissent from policy? \citet{carsonaust} and I debate the question at \citet{lawfareblog} 1/3

\url{https://t.co/Fxpq1cnPZr}
...
In a recent essay, \citet{UChicagoPoliSci}'s Austin Carson (\citet{carsonaust}) discusses instances when the Director of National Intelligence must be willing to disagree with the President, via \citet{lawfareblog}

Read at \url{https://t.co/YkCxR8BMvd}
...
c(``568282577'', ``390823537'', ``805833715'')

c(``UChicagoSSD'', ``UChicagoPoliSci'', ``carsonaust'')
...
The official page of the University of Chicago Division of the Social Sciences. News, events, and updates for students, faculty, staff, alumni, and friends.
...
\url{https://twitter.com/carsonaust/status/1182700887304744962}
...
\textbf{MPSA deadline extended}
If you didn't have a chance to submit, you still can! \url{https://t.co/KfZSPg6o7f}
...
\url{http://pbs.twimg.com/media/EGStvNyWoAExuf5.jpg}

\url{https://t.co/KfZSPg6o7f}

\url{https://twitter.com/carsonaust/status/1181260032916250624/photo/1}
...
Was just told it's sad women don't do strategic studies. Through my tears I used Google to locate smthg called ``Journal of Strategic Studies.'' 🧐 Current issue co-edited by woman 🙋‍♀️ \&amp; 4/7 articles have female authors 🙋‍♀️
But yes, stop hiding, lady experts!
...
Associate Professor \citet{GeorgetownCSS} \citet{GeorgetownSFS}. Senior Fellow \citet{BrookingsFP}. Military ops, defense policy, nuclear deterrence \& escalation, authoritarianism.
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-445-1} \end{center}
...
\CommentTok{#> # A tibble: 922 x 3}
\CommentTok{#> # Groups:   user_id [922]}
\CommentTok{#>   user_id             location                 n}
\CommentTok{#>   <chr>               <chr>                <int>}
\CommentTok{#> 1 2561373848          Florida, USA           101}
\CommentTok{#> 2 764290456599396353  Rochester, New York     45}
\CommentTok{#> 3 826869114           Paris, Ile-de-France    26}
\CommentTok{#> 4 84950267            ""                      20}
\CommentTok{#> 5 1030069194539368448 ""                      14}
\CommentTok{#> 6 1022122568004894720 ""                      13}
\CommentTok{#> # ... with 916 more rows}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{base.url =}\StringTok{ "http://api.nytimes.com/svc/search/v2/articlesearch.json"} 
\NormalTok{key =}\StringTok{ "Onz0BobMTn2IRJ7krcT5RXHknkGLqiaI"}
\NormalTok{search_term =}\StringTok{ "fleek"} \CommentTok{#change me}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-458-1} \end{center}
