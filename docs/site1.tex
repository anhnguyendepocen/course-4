...
\CommentTok{#> % Date and time: Sun, Oct 06, 2019 - 14:53:41}
...
\CommentTok{#> # A tibble: 782 x 3}
\CommentTok{#> # Groups:   user_id [782]}
\CommentTok{#>   user_id             location                n}
\CommentTok{#>   <chr>               <chr>               <int>}
\CommentTok{#> 1 2561373848          Florida, USA           87}
\CommentTok{#> 2 764290456599396353  Rochester, New York    63}
\CommentTok{#> 3 1022122568004894720 ""                     38}
\CommentTok{#> 4 1030069194539368448 ""                     35}
\CommentTok{#> 5 1026490600349229058 United States          15}
\CommentTok{#> 6 259312208           Traverse City, MI      13}
\CommentTok{#> # ... with 776 more rows}
\end{Highlighting}
\end{Shaded}
