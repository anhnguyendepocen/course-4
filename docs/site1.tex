...
Intel played a key role in Ukraine/impeachment. Key question now is:
Will Trump try to replace folks like acting DNI Maguire with more loyal
leaders?

My thoughts in \citet{lawfare} on why any effort by White House to
install a loyalist DNI is dangerous \url{https://t.co/FMRwWzvL3l}
...
\url{https://t.co/FMRwWzvL3l}

\url{https://www.lawfareblog.com/dangers-loyalist-director-national-intelligence}
...
\url{https://twitter.com/carsonaust/status/1178999436250423296}
...
\CommentTok{#> # A tibble: 664 x 3}
\CommentTok{#> # Groups:   user_id [664]}
\CommentTok{#>   user_id             location                           n}
\CommentTok{#>   <chr>               <chr>                          <int>}
\CommentTok{#> 1 2561373848          Florida, USA                      91}
\CommentTok{#> 2 764290456599396353  Rochester, New York               60}
\CommentTok{#> 3 1022122568004894720 ""                                36}
\CommentTok{#> 4 1030069194539368448 ""                                35}
\CommentTok{#> 5 714738130557992960  Chiclana de la Frontera, Spain    33}
\CommentTok{#> 6 826869114           Paris, Ile-de-France              31}
\CommentTok{#> # ... with 658 more rows}
\end{Highlighting}
\end{Shaded}
