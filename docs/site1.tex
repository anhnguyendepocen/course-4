...
and assignments through the Canvas website so that everyone can benefit
...
\subsubsection*{Readings and Resources}\label{readings-and-resources}
\addcontentsline{toc}{subsubsection}{Readings and Resources}

There are no official textbooks for this class. Some of the materials
are drawn from \href{https://r4ds.had.co.nz/}{R for Data Science} by
Garrett Grolemund and Hadley Wickham. I encourage you to refer back to
this back, as well as the many other R materials available for free
online.
...
\item
  \textbf{Dec 5} - TBD
\item
  \textbf{Dec 10} - Final project lightning talks
\end{enumerate}
...
Make 3 variables: \texttt{name} (with your full name), \texttt{city}
(where you were born) and \texttt{year} (when you were born.)
...
\NormalTok{basket <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(fruit, price) }\CommentTok{# add your vectors here}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Now give your dataframe appropriate column names.
\end{enumerate}
...
\NormalTok{color =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\StringTok{"orange"}\NormalTok{, }\StringTok{"yellow"}\NormalTok{)}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-207-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-208-1} \end{center}
...
\section{Challenges}\label{challenges-13}
...
\section{Challenges}\label{challenges-14}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-266-1} \end{center}
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-269-1} 

}

\caption{ }\label{fig:unnamed-chunk-269}
\end{figure}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-270-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-271-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-271-2} \end{center}
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-272-1} 

}

\caption{ }\label{fig:unnamed-chunk-272}
\end{figure}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-273-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-273-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-273-3} \end{center}
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-277-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-277-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-277-3} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-277-4} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-280-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-280-2} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-282-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-282-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-282-3} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-282-4} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-282-5} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-282-6} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-285-1} 
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-306-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-306-2} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-330-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-330-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-330-3} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-330-4} \end{center}
...
\CommentTok{#> % Date and time: Thu, Sep 19, 2019 - 14:02:51}
...
\citet{AndyLangenkamp} \citet{shifrinson} Wow that's a great question. I
hadn't thought about the casualties issue but now that you raise it,
it's conspicuously absent from discussion. Perhaps there were none. But
if there were, agree it's the kind of thing that makes restraint harder
...
\url{https://twitter.com/carsonaust/status/1174460469387681793}
...
washingtonpost.com/world/middle\_e\ldots{}
...
\url{https://twitter.com/carsonaust/status/1174399761044168709}
...
I'm thrilled this is out in \citet{INTPOLITSOCIO} ! On Sociability or
the ``play form of association'' (Simmel). Fostered over food, drink,
conversation. We all do it. We all need it. But we don't study it. I
illustrate w/ golfing and boozing in Cold War SEAsia
\url{https://t.co/1Acv9GYy1a} \url{https://t.co/EhhVY1jKzX}
...
Assistant Professor, NUS, Singapore. International Political Sociology,
Southeast Asia IR, Diplomacy, Political Ethnography, Practice theory,
Emotions, ASEAN.
...
\url{https://twitter.com/carsonaust/status/1174357621048008704}
...
Echoes distinctions made by \citet{shifrinson} in this thread
\url{https://t.co/0uO9OS3LsO}
...
twitter.com/shifrinson/sta\ldots{}

\url{https://t.co/0uO9OS3LsO}

\url{https://twitter.com/shifrinson/status/1174302699594145792?s=20}
...
A short thread. There's much chatter on how Iran may have responsibility
for the Saudi attack by (1) launching the attack on its own, (2)
providing weapons used in attack to a non-state group, or (2.5)
assisting a group in planning said attack. BLUF: these aren't the same
thing!
...
\url{https://twitter.com/carsonaust/status/1174348448759472128}
...
Saudis: Iran \emph{responsible for} attacks but stops short of saying
Tehran \emph{conducted} them. ``Iran or one of its proxies launched a
complex assault involving drones and cruise missiles.''

Ambiguity re: who conducted matters for response \&amp; escalation

\url{https://t.co/KKqkxZHZbp}
...
wsj.com/articles/saudi\ldots{}

\url{https://t.co/KKqkxZHZbp}

\url{https://www.wsj.com/articles/saudi-arabia-holds-iran-responsible-for-oil-attacks-11568820602?mod=hp_lead_pos6}
...
\url{https://twitter.com/carsonaust/status/1174348447618670593}
...
1/ \emph{CALL FOR SUBMISSIONS} I am organizing a panel at MPSA ``New
Directions in the Political Economy of International Security.'' Open to
methodological approach, time period, region, and issue. Please DM or
email me a 200-word abstract by Oct 1. Description to follow.
...
\url{https://twitter.com/carsonaust/status/1174077680448356361}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-426-1} \end{center}
...
\CommentTok{#> # A tibble: 711 x 3}
\CommentTok{#> # Groups:   user_id [711]}
\CommentTok{#>   user_id             location                n}
\CommentTok{#>   <chr>               <chr>               <int>}
\CommentTok{#> 1 2561373848          Florida, USA          109}
\CommentTok{#> 2 764290456599396353  Rochester, New York    40}
\CommentTok{#> 3 1022122568004894720 ""                     33}
\CommentTok{#> 4 1030069194539368448 ""                     32}
\CommentTok{#> 5 1260813006          Redmond, WA            20}
\CommentTok{#> 6 1048404121206714369 ""                     19}
\CommentTok{#> # ... with 705 more rows}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-468-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-478-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-479-1} \end{center}
