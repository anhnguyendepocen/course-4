...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{install.packages}\NormalTok{(}\StringTok{"knitr"}\NormalTok{, }\StringTok{"gapminder"}\NormalTok{, }\StringTok{"stargazer"}\NormalTok{, }\StringTok{"rtweet"}\NormalTok{, }\StringTok{"jsonlite"}\NormalTok{, }\StringTok{"httr"}\NormalTok{, }\StringTok{"rvest"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
