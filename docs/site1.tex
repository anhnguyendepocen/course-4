...
\CommentTok{#> % Date and time: Mon, Sep 30, 2019 - 13:43:02}
...
\CommentTok{#> # A tibble: 646 x 3}
\CommentTok{#> # Groups:   user_id [646]}
\CommentTok{#>   user_id             location                           n}
\CommentTok{#>   <chr>               <chr>                          <int>}
\CommentTok{#> 1 764290456599396353  Rochester, New York               68}
\CommentTok{#> 2 1022122568004894720 ""                                35}
\CommentTok{#> 3 1030069194539368448 ""                                35}
\CommentTok{#> 4 826869114           Paris, Ile-de-France              32}
\CommentTok{#> 5 714738130557992960  Chiclana de la Frontera, Spain    30}
\CommentTok{#> 6 496058145           ""                                21}
\CommentTok{#> # ... with 640 more rows}
\end{Highlighting}
\end{Shaded}
