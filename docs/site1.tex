...
See \href{install}{Install Page} for more information. We will be having
an \textbf{InstallFest on Wednesday, Oct 2 from 10am to 12pm}. for those
students experiencing difficulties downloading and installing the
requisite software.
...
\item
  ...
  \end{itemize}
\item
  \textbf{Oct 31} - Hypothesis testing and regressions
