...
\CommentTok{#> % Date and time: Mon, Oct 21, 2019 - 14:29:58}
...
\citet{OUPAcademic} in 2020: \url{https://t.co/LDYyA5vkMx}
...
\CommentTok{#> # A tibble: 765 x 3}
\CommentTok{#> # Groups:   user_id [765]}
\CommentTok{#>   user_id            location                           n}
\CommentTok{#>   <chr>              <chr>                          <int>}
\CommentTok{#> 1 2561373848         Florida, USA                      86}
\CommentTok{#> 2 764290456599396353 Rochester, New York               72}
...
\CommentTok{#> 6 578607700          New York City                     15}
\CommentTok{#> # ... with 759 more rows}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>  [5] "source"                  "multimedia"             }
\CommentTok{#>  [7] "keywords"                "pub_date"               }
\CommentTok{#>  [9] "document_type"           "news_desk"              }
\CommentTok{#> [11] "section_name"            "subsection_name"        }
\CommentTok{#> [13] "type_of_material"        "_id"                    }
\CommentTok{#> [15] "word_count"              "uri"                    }
\CommentTok{#> [17] "print_page"              "headline.main"          }
