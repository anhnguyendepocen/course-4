...
\CommentTok{#> % Date and time: Mon, Nov 04, 2019 - 13:05:26}
...
\item
  ...
  the two functions? What stringr function are they equivalent to? How
  do the functions differ in their handling of \texttt{NA}?
\item
...
\end{Shaded}
  ...
  \hypertarget{htmlwidget-aa348cd320424903da69}{}
...
\end{Shaded}
  ...
  \hypertarget{htmlwidget-c0b883f95c2bc807ca2a}{}
\item
...
\citet{ryan_brutger} This has become normal for me (4 yo and 17 month
old). And it is righteous and amazing
...
Please don't say that your paper fills a gap. If you have the urge, just
...
\citet{georgetownsfs} \& \citet{GUGovt} \textbar{} Blogger
\citet{lefarkins} \textbar{} New book, \#ExitFromHegemony coming from
\citet{OUPAcademic} in 2020: \url{https://t.co/LDYyA5dJUZ}
...
c(``pstanpolitics'', ``tanishafazal'', ``ProfPaulPoast'',
``ForeignAffairs'')
...
\citet{UChicago} political scientist and \citet{UChicagoCIR} director.
Research on international relations and political violence in South
Asia. Notifications muted.
...
Should intelligence officials publicly dissent from policy?
\citet{carsonaust} and I debate the question at \citet{lawfareblog} 1/3
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-470-1} \end{center}
...
\CommentTok{#> # A tibble: 794 x 3}
\CommentTok{#> # Groups:   user_id [794]}
\CommentTok{#>   user_id             location                n}
\CommentTok{#>   <chr>               <chr>               <int>}
\CommentTok{#> 1 2561373848          Florida, USA           93}
\CommentTok{#> 2 764290456599396353  Rochester, New York    71}
\CommentTok{#> 3 1030069194539368448 ""                     36}
\CommentTok{#> 4 1022122568004894720 ""                     35}
\CommentTok{#> 5 1048404121206714369 ""                     17}
\CommentTok{#> 6 1026490600349229058 United States          13}
\CommentTok{#> # ... with 788 more rows}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-514-1} \end{center}
...
\textbf{4.1 Subset dat so that it returns the third column AS A VECTOR}
(Do not print the object; store it in a variable.)
