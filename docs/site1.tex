...
\hypersetup{unicode=true,
            pdftitle={PLSC 31101: Introduction To Computational Tools And Techniques For Social Science},
...
\NormalTok{  knitr}\OperatorTok{::}\KeywordTok{asis_output}\NormalTok{(}\StringTok{'}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{url\{....\}'}\NormalTok{)}
\NormalTok{\} }\ControlFlowTok{else}\NormalTok{ \{}
\NormalTok{  knitr}\OperatorTok{::}\KeywordTok{include_graphics}\NormalTok{(}\StringTok{"img/tony_stark.gif"}\NormalTok{)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#knitr::include_graphics(path = "img/tony_stark.gif")}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#knitr::include_graphics(path = "img/mulder.gif")}
\end{Highlighting}
\end{Shaded}
...
\addcontentsline{toc}{subsubsection}{Challenge 1. Create a new R
Markdown document with \emph{File \textgreater{} New File \textgreater{}
R Markdown\ldots{}} Read the instructions. Practice running the chunks.
Verify that you can modify the code, re-run it, and see modified
output.}
...
\addcontentsline{toc}{subsubsection}{Challenge 2. Knit the document into
an html file. Verify that you can modify the input and see the output
update.}
...
\CommentTok{# Do it using a conditional statement (and an implicit logical vector)}
\NormalTok{country.vector[}\OperatorTok{!}\NormalTok{country.vector }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Canada"}\NormalTok{, }\StringTok{"Brazil"}\NormalTok{)]}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-223-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-224-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-288-1} \end{center}
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-289-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-290-1} 
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-293-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-293-2} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-295-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-295-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-295-3} \end{center}
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-297-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-299-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-299-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-299-3} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-299-4} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-302-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-302-2} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-303-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-303-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-303-3} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-303-4} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-303-5} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-305-1} 

}

\caption{ }\label{fig:unnamed-chunk-305}
\end{figure}
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-306-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-307-1} 
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-328-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-328-2} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-330-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-330-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-330-3} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-337-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-355-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-355-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-355-3} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-355-4} \end{center}
...
\CommentTok{#> % Date and time: Sat, Sep 28, 2019 - 15:57:35}
...
``I have never seen a more buttoned-up set of whistleblower allegations
than these.'' \url{https://t.co/0kttzYrDlg}
...
thehill.com/opinion/white-\ldots{}

\url{https://t.co/0kttzYrDlg}

\url{https://thehill.com/opinion/white-house/463396-the-intelligence-community-strikes-back-an-impeachment-game-changer?amp\&__twitter_impression=true}
...
Assistant Professor of Digital Media and Global Affairs at the
...
washingtonpost.com/national-secur\ldots{}

\url{https://t.co/EOTm6UuUlP}

\url{https://www.washingtonpost.com/national-security/trump-told-russian-officials-in-2017-he-wasnt-concerned-about-moscows-interference-in-us-election/2019/09/27/b20a8bc8-e159-11e9-b199-f638bf2c340f_story.html}
...
\url{https://twitter.com/carsonaust/status/1177755874061893632}
...
\citet{AudieKlotz} Yes and an age pattern, too
...
\url{https://twitter.com/carsonaust/status/1177748049587789825}
...
\citet{anthlittle} \citet{dhnexon} So defensive, \citet{anthlittle}
...
\url{https://twitter.com/carsonaust/status/1177646359903645698}
...
Secret Wars, by \citet{UChicago}'s own \citet{carsonaust}, recently won
the 2018 Lepgold Book Prize in international affairs. Dr.~Carson and
\citet{pstanpolitics} (a previous winner) join \citet{tyfys_podcast} to
discuss the book and other topics in \#civmil relations
\citet{HarrisPolicy} \url{https://t.co/eiFGyuCyHZ}
...
c(``tyfys\_podcast'', ``UChicago'', ``carsonaust'')
...
A Hard Look at American Civil-Military Affairs from \citet{TheUC3P}
\citet{HarrisPolicy} \textbar{} Hosted by \citet{krasnican_} \&
\citet{na_paraiso} \textbar{} New episodes coming soon!
...
\url{https://twitter.com/carsonaust/status/1177626170583584773}
...
\citet{dhnexon} Gasp! It can't be true!
...
\url{https://twitter.com/carsonaust/status/1177618566625058816}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-451-1} \end{center}
...
\CommentTok{#> # A tibble: 657 x 3}
\CommentTok{#> # Groups:   user_id [657]}
\CommentTok{#>   user_id             location                           n}
\CommentTok{#>   <chr>               <chr>                          <int>}
\CommentTok{#> 1 2561373848          Florida, USA                      91}
\CommentTok{#> 2 764290456599396353  Rochester, New York               51}
\CommentTok{#> 3 1030069194539368448 ""                                34}
\CommentTok{#> 4 1022122568004894720 ""                                33}
\CommentTok{#> 5 714738130557992960  Chiclana de la Frontera, Spain    28}
\CommentTok{#> 6 826869114           Paris, Ile-de-France              27}
\CommentTok{#> # ... with 651 more rows}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-464-1} \end{center}
...
{[}hint1{]}: To find this information, open a command line window
(`terminal' or, on windows, `git bash'), and enter the following command
\texttt{R\ -\/-version}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-493-1} \end{center}
...
\subsection{Assignment 2 Solutions}\label{assignment-2-solutions}
...
\subsubsection*{1. Basics}\label{basics-1}
\addcontentsline{toc}{subsubsection}{1. Basics}
...
\subsubsection*{2. Vectors and Lists}\label{vectors-and-lists-1}
\addcontentsline{toc}{subsubsection}{2. Vectors and Lists}
...
\subsubsection*{3. Factors}\label{factors-2}
\addcontentsline{toc}{subsubsection}{3. Factors}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-504-1} \end{center}

\subsubsection*{4. Dataframes}\label{dataframes-2}
\addcontentsline{toc}{subsubsection}{4. Dataframes}
...
\textbf{1.1 Initialize a project where you store this \texttt{.Rmd}
file. Using \texttt{getwd()}, print your working directory below.}
...
\textbf{1.2 Download the \texttt{country-year.csv} file and store it in
a subdirectory of your project called \texttt{data}.}

\textbf{Read \texttt{country-year.csv} into R, using a relative path.
Store it in an object called \texttt{dat}.}
...
\textbf{3.3 What is the range of \texttt{polity2}? How many NAs are in
this column?}
...
\textbf{4.1 Subset the data so that it returns the third column AS ITS
OWN A DATAFRAME.} (Do not print the object; store it in a variable.)
...
\textbf{4.2 Subset gapminder so that it returns the third column AS A
VECTOR} (Do not print the object; store it in a variable.)
...
\textbf{4.3 Fix each of the following common data frame subsetting
errors}:
...
\textbf{4.5 Subset the data to include only observations from years
...
\textbf{4.6 Using \texttt{mean()} function, tell me the average GDP of
...
\textbf{4.7 You just calculated the average GDP for years 1990-2000. Now
...
\textbf{4.8 Look up the helpfile for the function \texttt{is.na()}.
...
\subsection{Assignment 3 Solutions}\label{assignment-3-solutions}
...
\subsubsection*{1. R Projects and
Importing}\label{r-projects-and-importing-1}
\addcontentsline{toc}{subsubsection}{1. R Projects and Importing}
...
\subsubsection*{2. Dimensions and Names}\label{dimensions-and-names-1}
\addcontentsline{toc}{subsubsection}{2. Dimensions and Names}
...
\subsubsection*{3. Summarizing}\label{summarizing-1}
\addcontentsline{toc}{subsubsection}{3. Summarizing}
...
\subsubsection*{4. Subsetting}\label{subsetting-2}
\addcontentsline{toc}{subsubsection}{4. Subsetting}
