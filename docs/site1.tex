...
\CommentTok{#> # A tibble: 672 x 3}
\CommentTok{#> # Groups:   user_id [672]}
\CommentTok{#>   user_id             location                           n}
\CommentTok{#>   <chr>               <chr>                          <int>}
\CommentTok{#> 1 764290456599396353  Rochester, New York               69}
\CommentTok{#> 2 1022122568004894720 ""                                36}
\CommentTok{#> 3 1030069194539368448 ""                                36}
\CommentTok{#> 4 714738130557992960  Chiclana de la Frontera, Spain    32}
\CommentTok{#> 5 826869114           Paris, Ile-de-France              31}
\CommentTok{#> 6 496058145           ""                                21}
\CommentTok{#> # ... with 666 more rows}
\end{Highlighting}
\end{Shaded}
