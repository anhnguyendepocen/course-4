...
\item
  \textbf{\protect\hyperlink{r-syntax}{R Syntax}}, describing how R
  wants you to write commands;
\item
  \textbf{{[}R Packages{]}}, extra tools and functionality;
\item
  \textbf{\protect\hyperlink{r-markdown}{R Markdown}}, a kind of R
...
useful both for statistics but also data science. It's inspired by the
programming language
\href{https://en.wikipedia.org/wiki/S_(programming_language)}{\texttt{S}}.
Some of it's \textbf{best features} are:
...
\item
  ...
  visualisation, and importing and manipulating data. Over 14,000
  packages are available as of August 2019. Whatever model or graphic
  you're trying to do, chances are that someone has already tried to do
  it.
\item
  Designed for statistics and data analysis, but also general-purpose
  programming.
\item
  An \href{http://www.rstudio.com/ide/}{Interactive Development
...
But it's not exactly ideal. We can't easily write and edit scripts as we
go. It's not very pretty. There are no debugging tools. That's why most
people who use R (or Python, etc) use an ``integrated development
environment'' or ``interactive development environment'' (IDE).
...
\def\labelenumi{\arabic{enumi}.}
\item
  Retreiving previous commands: As you work with R you'll often want to
...
It is better to enter the commands in the script editor, and save the
...
needed. Open it up either by clicking the \emph{File} menu, and
...
You can copy-paste code from the editor into the console, but there is a
better way. The key to using the script editor effectively is to
memorise one of the most important keyboard shortcuts:
...
Anything to the right of a \texttt{\#} is ignored by R. Add a \# to each
line of comments.
...
If we want to remove all objects from your current environment, we can
run:
...
results, and prose commentary into one document. Think of R Markdown
files as modern day lab notebook, where you can capture not only what
you did, but also what you were thinking.

The filename should end in \texttt{.Rmd} or \texttt{.rmd}. They can also
be converted to an output format, like PDF, HTML, slideshows, Word
files, and more.
...
click the ``Knit'' button (looks like a ball of yarn) or press
\texttt{Cmd/Ctrl\ +\ Shift\ +\ K}. This will display the report in the
viewer pane, and create a self-contained HTML file that you can share
with others. The \texttt{.html} file is written in the same directory as
your \texttt{.Rmd} file.
...
``libraries''). A \emph{library} is a collection of functions that can
be used by other programs. May also contain data. Library's contents are
supposed to be related, but there's no way to enforce that.

\subsection{Installing Packages}\label{installing-packages}

Using packages requires two steps.

We first download the package from one of the CRAN mirror onto our
computer. For this we use \texttt{install.packages("package-name")}. If
you have not set a preferred CRAN mirror in your \texttt{options()},
then a menu will pop up asking you to choose a location.
...
\texttt{install.packages} again (unless we get a new compute.)

\subsection{Loading Packages}\label{loading-packages}

Once we download the package, we need to load it into our session to use
it. It is required at the beginning of each R session. This step is
necessary because, if we automatically load every package we have ever
...
The message tells you which functions from the dplyr conflict with
...
\hypertarget{r-syntax}{\chapter{R Syntax}\label{r-syntax}}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-205-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-206-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-264-1} \end{center}
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-265-1} 
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-268-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-269-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-269-2} \end{center}
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-270-1} 
...
\begin{center}\includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-271-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-271-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-271-3} \end{center}
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-273-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-275-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-275-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-275-3} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-275-4} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-278-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-278-2} 
...
{\centering \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-279-1} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-279-2} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-279-3} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-279-4} \includegraphics[width=0.7\linewidth]{site1_files/figure-latex/unnamed-chunk-279-5} 
...
\CommentTok{#> % Date and time: Mon, Sep 16, 2019 - 21:20:10}
...
Great list of factors relevant to escalation by \citet{ProfPaulPoast},
applied to Saudi/Iran/US \url{https://t.co/EWYHdPJM7j}
...
twitter.com/ProfPaulPoast/\ldots{}

\url{https://t.co/EWYHdPJM7j}

\url{https://twitter.com/ProfPaulPoast/status/1173555382872137728}
...
Are we on the cusp of major war in the Gulf? Can the events leading to
WWI help us answer than question?

Those are the questions implied by 👇question from yesterday.

{[}THREAD{]} \url{https://t.co/Qp15VHQ7vr}
...
\citet{UChicago} international relations (IR) prof \&
\citet{ChicagoCouncil} Fellow. IR Research/Teaching \& Foreign Affairs.
New book ``Arguing About Alliances'' (\citet{CornellPress})
...
\url{https://twitter.com/carsonaust/status/1173621242861166594}
...
\CommentTok{#> # A tibble: 665 x 3}
\CommentTok{#> # Groups:   user_id [665]}
