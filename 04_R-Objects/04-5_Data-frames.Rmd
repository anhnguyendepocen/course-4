...
Beware: `data.frame()`'s default behaviour which turns strings into factors. Use `stringAsFactors = FALSE` to suppress this behaviour as needed:
...
price = c(.89, .99, 1.00)
basket <- data.frame(fruit, price) # add your vectors here
```

2. Now give your dataframe appropriate column names.
