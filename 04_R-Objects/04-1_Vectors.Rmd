...
Vectors are 1-dimensional chain of values. We call each value an _element_ of a vector. 
...
Remember that elements of a vector must be the same type. So when you attempt to combine different types they will be __coerced__ to the most "flexible" type. 
...
#### 1: Create and examine your vector
