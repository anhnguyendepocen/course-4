...
How do we know what kinds of arguments to pass into a functiion? Every built-in function comes with ___documentation__.
...
Using the help files for `max`, explain why it return the result it does.
